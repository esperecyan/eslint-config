declare const _default: (import("eslint").Linter.Config<import("eslint").Linter.RulesRecord> | {
    ...
    rules: {
        ...
        '@stylistic/object-curly-spacing': ["warn", string];
        '@stylistic/indent': ["warn", string, {
            SwitchCase: number;
            outerIIFEBody: string;
            ignoredNodes: string[];
        }];
        '@stylistic/quotes': ["warn", string, {
            avoidEscape: boolean;
        }];
        eqeqeq: "warn";
        'no-alert': "warn";
        ...
        '@stylistic/spaced-comment': ["warn", string, {
            block: {
                markers: string[];
            };
            line: {
